...
const Features = () => {
  ...
  return (
     <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
         ...
         <div className="flex items-center gap-2 text-sm text-blue-600 bg-green-500/10  rounded-full px-6 py-1.5">
            <Zap width={14} />
            <span>Simple Process</span>
        </div>
        <Title title='Build your resume' description="our streamlined process helps your create a profession resume in minutes with intelligent AI-powered tool and features" />


            <div className="flex flex-col md:flex-row items-center justify-center ml:-mt-10">
