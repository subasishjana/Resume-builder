...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  return (
    <div className="relative">
      {/* toggle dropdown */}
      <button
        onClick={() => setIsOpen(!isOpen)} // <-- missing before
      ...
      {isOpen && (
        <div className="absolute top-full w-64 p-3 mt-2 space-y-3 z-10 bg-white rounded-lg border border-gray-200 shadow-sm">
